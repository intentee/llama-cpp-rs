...
impl LlamaContext<'_> {
    ...
    pub fn kv_cache_seq_add(
        ...
        let p1 = p1
            ...
            .map_err(KvCacheConversionError::P1TooLarge)?;
        let mem = unsafe { llama_cpp_bindings_sys::llama_get_memory(self.context.as_ptr()) };
        unsafe { llama_cpp_bindings_sys::llama_memory_seq_add(mem, seq_id, p0, p1, delta) };
        Ok(())
    }
    ...
    pub fn kv_cache_seq_div(
        ...
        let mem = unsafe { llama_cpp_bindings_sys::llama_get_memory(self.context.as_ptr()) };
        unsafe { llama_cpp_bindings_sys::llama_memory_seq_div(mem, seq_id, p0, p1, d) }
        Ok(())
    }
    ...
    pub fn kv_cache_seq_pos_max(&self, seq_id: i32) -> i32 {
        let mem = unsafe { llama_cpp_bindings_sys::llama_get_memory(self.context.as_ptr()) };
        unsafe { llama_cpp_bindings_sys::llama_memory_seq_pos_max(mem, seq_id) }
    }
}
